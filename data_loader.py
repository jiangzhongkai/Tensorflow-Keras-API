...
def get_datasets(config=Config(), cat_before_window= False, shuffled= True,default_file="conf/NASDAQ100.json"):
    """
    ...
    test_size = 537
    val_size=test_size
    train_size=len(X_T)-test_size*2
